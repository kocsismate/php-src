...
ZEND_INI_BEGIN()
	...
	STD_ZEND_INI_BOOLEAN("zend.debug_locale_sensitive_float_casts",	"1",	ZEND_INI_ALL,		OnUpdateBool, debug_locale_sensitive_float_casts, zend_executor_globals, executor_globals)
ZEND_INI_END()
