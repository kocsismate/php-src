--TEST--
Test that initonly static properties can't be mutated
--FILE--
<?php

class Foo
{
    initonly public static int $property1;
    initonly public static string $property2 = "Foo";
...
?>
--EXPECT--
Cannot modify initonly static property Foo::$property1 after initialization
